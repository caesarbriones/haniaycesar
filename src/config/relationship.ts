...
export const relationshipConfig = {
  ...
  // 👨 Datos sobre César
  yourFacts: [
    { icon: "🧘", label: "Cómo me describo", value: "Paciente, tranquilo y amoroso" },
    { icon: "⚖️", label: "Algo bueno de mí", value: "Mi neutralidad" },
    { icon: "🫥", label: "Algo que me cuesta", value: "A veces tengo síndrome del impostor" },
    { icon: "💕", label: "Lo que me hace feliz", value: "Estar con mi Hannita" },
    { icon: "💔", label: "Lo que me baja el ánimo", value: "Sentir falta de interés" },
    { icon: "🗣️", label: "Cuando estoy triste", value: "Prefiero estar solo, pero con Hannia prefiero hablarlo" },
    { icon: "🧠", label: "Cuando estoy enojado", value: "Necesito reflexionar, pero prefiero hablarlo y no dejarla así" },
    { icon: "🙈", label: "Cómo manejo mis emociones", value: "Pedir perdón y expresar lo que siento" },
    { icon: "💫", label: "Cómo veo a Hannia", value: "Es algo especial; es mi alma gemela" },
    { icon: "✨", label: "Lo primero que me llamó la atención", value: "Todo, pero especialmente su personalidad" },
    { icon: "💗", label: "Lo que más admiro de ella", value: "Su empatía" },
    { icon: "🤝", label: "Lo que me hace sentir querido", value: "Que siempre quiera estar conmigo" },
    { icon: "💬", label: "Cómo le digo", value: "Amor, corazón y apodos parecidos" },
    { icon: "❤️", label: "Si Hannia duda de mi amor", value: "La quiero a pesar de todo y se lo demostraría" },
    { icon: "🫂", label: "Si Hannia está triste", value: "Estaré aquí para ella, sea lo que sea" },
    { icon: "😴", label: "Un recuerdo que quiero", value: "Dormir con ella" },
    { icon: "📅", label: "Mi cita perfecta", value: "Cualquier plan con Hannia es perfecto" },
    { icon: "☕", label: "Un regalo que me gusta", value: "Algo relacionado con el café, aunque si es de ella me basta" },
    { icon: "🎁", label: "Un regalo para Hannia", value: "Todo; se merece todo, la guapa" },
    { icon: "🏋️", label: "Actividad que disfruto", value: "Cardio en casa" },
    { icon: "🎪", label: "Serie que vemos", value: "The Amazing Digital Circus" },
    { icon: "🎵", label: "Canciones que relaciono con ella", value: "Todas las que me dedica" },
    { icon: "🇨🇭", label: "Lugar que quiero visitar", value: "Suiza" },
    { icon: "💍", label: "Sueño personal", value: "Casarme" },
    { icon: "☕", label: "Sueño juntos", value: "Tener una cafetería" },
    { icon: "😅", label: "Muletilla", value: "Ehwmmm" },
    { icon: "😂", label: "Broma con Hannia", value: "Siempre digo que yo la quiero más que nada" },
